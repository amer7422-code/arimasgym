// ============================================================
// Gym Engine - Backend حقيقي لتسجيل الدخول وإنشاء الحسابات
...
// ------------------------------------------------------------
const db = new Database(path.join(__dirname, 'gymengine.db'));
...
app.listen(PORT, () => {
  console.log(`✅ Gym Engine backend يعمل على http://localhost:${PORT}`);
});
